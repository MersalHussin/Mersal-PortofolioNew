...
const Clients = () => {
  ...
  const cardClasses = `
    group relative 
    w-20 h-10 sm:w-28 sm:h-20 md:w-36 md:h-24 lg:w-40 lg:h-28
  ...
  return (
    <section className="w-full py-10 md:py-[60px]">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-10 gap-y-8 sm:gap-y-12">
